...
public class Adept {
  ...
  public static BufferedReader section5(String urlText) throws IOException {
    ...
    InputStream url = new URL(urlText).openStream();
    InputStreamReader inputstream = new InputStreamReader(url);
  ...
  public static String section6(String urlText) throws IOException {
    ...
    try {
      ...
      return_output = "";
      String current_string = bufferedreader.readLine();
      while (current_string != null) {
        return_output += current_string;
